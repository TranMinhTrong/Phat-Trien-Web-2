package com.trong.baitap.BaiTapLap2.controller;
...
//@WebServlet({"/TamGiacServlet/chuvi", "/TamGiacServlet/dientich" })
@WebServlet({"/TamGiacServerlet/chuvi", "/TamGiacServerlet/dientich" })
public class TamGiacServerlet extends HttpServlet {
